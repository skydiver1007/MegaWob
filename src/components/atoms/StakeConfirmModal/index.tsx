...
const ModalComponent = (props: any) => {
  const { onClose, info, index, open, onConfirm } = props;
        ...
        <div className={`${classes.modalDiv} text-center font-quick`}>
          <div className={`${classes.innerTextDiv}`}>
            ...
            <p className='mt-16 font-quick'>
              If you are sure of this action, please click <strong>CONFIRM</strong> and approve the transaction sent to your Solana wallet.
            </p>
          </div>
